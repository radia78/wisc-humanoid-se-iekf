...
from whse.iekf.dynamics import IEKFDynamics
from whse.iekf.types import IMUMeasurement
...
class ContactBiasIEKF:
    ...
    def make_state(
        self, R=None, v=None, p=None, dl=None, dr=None, b_L=None, b_R=None, P=None
    ):
    ...
    def propagate(self, state, gyro_bias, accel_bias, imu: IMUMeasurement, dt):
        ...
        """
        X_new = self.base.propagate_state(state.X, gyro_bias, accel_bias, imu, dt)
        F = self.compute_F(dt)
        Q = self.compute_Q(dt)
